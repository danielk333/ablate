...
xx = mod.modele_gsi(20, 50, 0.5, 360 )
...
class Longlune2024(ScipyODESolve):
    ...
    def rhs(self, t, mass, y, material_data, Lambda, Gamma, epoch):
        ...
        dmdt = dmdt_a #total mass loss

        ret = np.array([dmdt, dvdt, dsdt], dtype=np.float64)
    ...
    def run(self,
        ...
        **Keyword arguments:**
        ...
        y0 = np.array([mass0, velocity0, s0], dtype=np.float64)
    ...
    def _allocate(self, t):
        ...
        _data = {}
        for key in ['mass','velocity','position', 'ecef_x', 'ecef_y', 'ecef_z', 'altitude']:
